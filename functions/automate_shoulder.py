...
bpy.ops.object.mode_set(mode='EDIT')
bpy.ops.mesh.bisect(plane_co=(19,19, chest_z), plane_no=(0, 0, 1), clear_inner=True, clear_outer=False)
bpy.ops.mesh.bisect(plane_co=(19, hand_x, 19),plane_no=(1, 0, 0), clear_inner=True, clear_outer=False)
bpy.ops.object.mode_set(mode='OBJECT')
