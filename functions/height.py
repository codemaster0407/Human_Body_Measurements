...
filepath = "C:\\Users\\schai\\OneDrive\\Desktop\\Course Project\\3d_model_photo.obj"
...
# # Bisect the mesh
# bpy.ops.object.mode_set(mode='EDIT')
# bpy.ops.mesh.bisect(plane_co=(19,19, 0.0), plane_no=(0, 0, 1), clear_inner=True, clear_outer=False)
# bpy.ops.object.mode_set(mode='OBJECT')
# mesh = obj.data
...
# print("Length of waist in (in):", str(num_vertices * 0.05663430420711974))
